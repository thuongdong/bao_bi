...
<section class="counter" style="background: url(wp-content/uploads/2020/10/banner2.jpg) center; background-size: cover; background-attachment: fixed;">
  <div class="overlay"></div>
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work1.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work2.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work3.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work4.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work5.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
        <a href="portfolio-single.html">
          <div class="content">
            ...
            <div class="image">
              <img src="wp-content/uploads/2020/10/work6.jpg" alt="Portfolio image">
            </div>
          </div><!--/.content -->
        </a>
      </div><!--/.item -->
...
<section class="testimonial text-center" id="testimonial" style="background: url(wp-content/uploads/2020/10/banner3.jpg) center; background-size: cover; background-attachment: fixed;">
  <div class="overlay"></div>
    ...
    <div class="container">
      <div class="carousel-inner">
        <div class="item active">
          <div class="photo">
            <img src="wp-content/uploads/2020/10/person1.jpg" alt="Testimonial">
          </div>
          <div class="text">
        ...
        <div class="item">
          <div class="photo">
            <img src="wp-content/uploads/2020/10/person2.jpg" alt="Testimonial">
          </div>
          <div class="text">
            " Nullam rhoncus suscipit mauris, sit amet suscipit nisi eleifend et. Lorem Ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus suscipit mauris, sit amet suscipit nisi   eleifend et consectetur adipiscing elit. "
          </div>
...
<section class="twitter-feed" style="background: url(wp-content/uploads/2020/10/banner4.jpg) center; background-size: cover; background-attachment: fixed;">
  <div class="overlay"></div>
  ...
  <div class="container">
    ...
    <div id="masonry-container">
      ...
      <article class="col-md-4 col-sm-6 masonry wow animated fadeIn">
        <div class="journal-content">
          <div class="media">
            <img src="wp-content/uploads/2020/10/news1.jpg" alt="news content">
          </div>
          <div class="detail">
      ...
      <article class="col-md-4 col-sm-6 masonry wow animated fadeIn">
        <div class="journal-content">
          <div class="media">
            <img src="wp-content/uploads/2020/10/news2.jpg" alt="news content">
          </div>
          <div class="detail">
            <div class="category-wrap"><div class="category"><i class="pe-7s-photo"></i></div></div>
            <div class="title"><a href="journal-single.html"><h3>Lorem Ipsum dolor sit amet</h3></a></div>
...
<section class="clients">
  <div class="container">
    ...
    <div id="clients" class="clients-logo owl-theme wow animated fadeIn">
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client1.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client2.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client3.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client4.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client5.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client6.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client7.png" alt="clients"></a>
      </div>
      <div class="item">
        <a href="#"><img src="wp-content/uploads/2020/10/client8.png" alt="clients"></a>
      </div>
    </div>
  </div><!--/.container -->
</section><!--/.clients -->
